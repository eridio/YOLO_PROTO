...
use crate::src_2R::kdf_root::{kdf_rk, kdf_rk_he};
use crate::src_2R::header::Header;

use crate::src_2R::kdf_chain::kdf_ck;
use crate::src_2R::aead::{encrypt, decrypt};
use zeroize::Zeroize;
use rand_core::OsRng;
...
pub struct Ratchet {
    ...
    pub nr: usize,
    pub pn: usize,
    pub mkskipped: HashMap<(Vec<u8>, usize), [u8; 32]>,
}
